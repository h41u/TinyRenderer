...
void triangle2 (TGAImage &image,int color,Vec3f d0,int vn0,Vec3f d1, int vn1,Vec3f d2, int vn2) {
...
int main() {
	...
	triangle2(image,pdtScalaire,b[0],drawLine[0],b[1],drawLine[1],b[2],drawLine[2]) ;
	}
